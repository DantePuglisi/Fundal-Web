...
function Form() {
    ...
    return (
        ...
        //                     <span className="text-sm font-bold text-black-700" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>Hp</span>
        //                     <Toggle
        //                         checked={form.hp_or_kw}
        //                         onChange={val => setForm(prev => ({ ...prev, hp_or_kw: val }))}
        //                         id="hp-or-kw-toggle"
        //                     />
        //                     <span className="text-sm font-bold text-black-700" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>Kw</span>
        //                     <input
        //                         type="number"
        //                         name="potencia"
        //                         value={form.potencia}
        ...
        //         <div className="grid grid-cols-3 gap-4 mb-4 items-center">
        //             <div>
        //                 <label className="block mb-1 font-medium" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>¿Tiene Reductor?</label>
        //                 <div className="flex items-center gap-2">
        //                     <span className="text-sm font-bold text-black-700" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>NO</span>
        //                     <Toggle
        ...
        //                         id="reductor-toggle"
        //                 />
        //                 <span className="text-sm font-bold text-black-700" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>SÍ</span>
        //                 </div>
        //             </div>
        //             {form.reductor && (
        //                 <>
        //                     <div>
        //                         <label className="block mb-1 font-medium" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>Relación (rpm):</label>
        //                         <input
        //                             type="text"
        //                             name="relacion"
        ...
        //                     </div>
        //                     <div>
        //                         <label className="block mb-1 font-medium" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>Ø de eje salida del reductor:</label>
        //                         <input
        //                             type="text"
        //                             name="ejeSalida"
        ...
        //                     </div>
        //                     <div>
        //                         <label className="block mb-1 font-medium" style={{ fontFamily: 'Poppins' }} style={{ fontFamily: 'Poppins' }}>Ø de eje conducido:</label>
        //                         <input
        //                             type="text"
        //                             name="ejeConducido"
